...
knitr::include_graphics('SNPs_slides_files/figure-html/pillars-1.svg', dpi = NA)
```
]
...
.img-infinium[![](SNPs_slides_files/images/infinium.png)]
...
![](SNPs_slides_files/images/nata.jpg)
]
...
.mcmahon-left[
.mcmahon-meme[
![](SNPs_slides_files/images/mcmahon-1.jfif)
...
.mcmahon-right[
.mcmahon-meme[
![](SNPs_slides_files/images/mcmahon-2.jfif)
...
.mcmahon-left[
.mcmahon-meme[
![](SNPs_slides_files/images/mcmahon-3.jfif)
...
.mcmahon-right[
.mcmahon-meme[
![](SNPs_slides_files/images/mcmahon-4.jfif)
...
.me-right[
.mcmahon-meme[![](SNPs_slides_files/images/JM.jfif)]
]
...
||
-|-
Self-taught Programmer | ![](SNPs_slides_files/images/python.png) | ![](SNPs_slides_files/images/R_logo.png)
Thinks he can do Data Science |  ![](SNPs_slides_files/images/dsc.jfif) | .eqn[ $$p(X)=\beta\_{0}+\beta\_{1}X$$]
Trying to be a Web Designer | ![](SNPs_slides_files/images/django.png) | ![](SNPs_slides_files/images/web.jfif)
